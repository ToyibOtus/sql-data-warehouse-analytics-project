...
===============================================================================================================
Script Purpose:
	This script loads [bronze.erp_loc_a101]. It also performs logging operations, by inserting vital
...
===============================================================================================================
*/
CREATE OR ALTER PROCEDURE bronze.usp_load_bronze_erp_loc_a101 @job_run_id UNIQUEIDENTIFIER = NULL AS
BEGIN
	...
	@step_name NVARCHAR(50) = 'usp_load_bronze_erp_loc_a101',
	@start_time DATETIME,
	@end_time DATETIME,
	@step_duration INT,
	...
	BEGIN TRY
		...
		SELECT @rows_source = COUNT(*) FROM landing.erp_loc_a101;
