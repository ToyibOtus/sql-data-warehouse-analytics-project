...
===============================================================================================================
Script Purpose:
	This script loads [bronze.erp_cust_az12]. It also performs logging operations, by inserting vital
...
===============================================================================================================
*/
CREATE OR ALTER PROCEDURE bronze.usp_load_bronze_erp_cust_az12 @job_run_id UNIQUEIDENTIFIER = NULL AS
BEGIN
	...
	@step_name NVARCHAR(50) = 'usp_load_bronze_erp_cust_az12',
	@start_time DATETIME,
	@end_time DATETIME,
	@step_duration INT,
	...
	BEGIN TRY
		...
		SELECT @rows_source = COUNT(*) FROM landing.erp_cust_az12;
		...
		(
			SELECT 
				...
				COALESCE(TRIM(UPPER(CAST(gen AS NVARCHAR(50)))), '~')) AS dwh_raw_row
