...
==================================================================================================================
Script Purpose:
	This script loads the silver table [silver.erp_loc_a101]. It performs series of data transformations such
	as data cleansing, enrichment, and standardization.

Parameter: @job_run_id UNIQUEIDENTIFIER = NULL

Usage: EXEC silver.usp_load_silver_erp_loc_a101;
...
==================================================================================================================
*/
CREATE OR ALTER PROCEDURE silver.usp_load_silver_erp_loc_a101 @job_run_id UNIQUEIDENTIFIER = NULL AS 
BEGIN
	...
	@step_name NVARCHAR(50) = 'usp_load_silver_erp_loc_a101',
	@start_time DATETIME,
	@end_time DATETIME,
	@step_duration INT,
	...
	@rows_loaded INT,
	@rows_diff INT,
	@source_path NVARCHAR(50) = 'bronze.erp_loc_a101',
	@pk_nulls INT,
	@pk_duplicates INT;
	...
	BEGIN TRY
		...
		TRUNCATE TABLE silver_stg.erp_loc_a101;
		...
		INSERT INTO silver_stg.erp_loc_a101
		(
			cid,
			cntry,
			dwh_step_run_id,
		...
		LEFT JOIN silver.erp_loc_a101 sel
		ON mc.cid = sel.cid 
		AND mc.dwh_row_hash = sel.dwh_row_hash
		WHERE sel.dwh_row_hash IS NULL;

		-- Retrieve total number of new records from silver_stg
		SELECT @rows_source = COUNT(*) FROM silver_stg.erp_loc_a101;
		...
		DROP TABLE IF EXISTS #dq_metrics_erp_loc_a101;
		...
		SELECT
			...
			INTO #dq_metrics_erp_loc_a101
		FROM silver_stg.erp_loc_a101;
		...
		MERGE silver.erp_loc_a101 tgt
		USING silver_stg.erp_loc_a101 src
			ON tgt.cid = src.cid
