...
=====================================================================================================
Script Purpose:
	This script loads [landing.crm_cust_info]. It also performs logging operations by loading vital
	log details into log tables [etl_step_run] & [etl_error_log].

Parameter: @job_run_id UNIQUEIDENTIFIER = NULL

Usage: EXEC landing.usp_load_landing_crm_cust_info;
...
=====================================================================================================
*/
CREATE OR ALTER PROCEDURE landing.usp_load_landing_crm_cust_info @job_run_id UNIQUEIDENTIFIER = NULL AS
BEGIN
	...
	@step_name NVARCHAR(50) = 'usp_load_landing_crm_cust_info',
	@start_time DATETIME,
	@end_time DATETIME,
	@step_duration INT,
	...
	BEGIN TRY
		...
		SELECT @rows_loaded = COUNT(*) FROM landing.crm_cust_info;
