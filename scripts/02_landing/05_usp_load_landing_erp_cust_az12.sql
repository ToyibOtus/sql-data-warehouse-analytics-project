...
=====================================================================================================
Script Purpose:
	This script loads [landing.erp_cust_az12]. It also performs logging operations by loading vital
...
BEGIN
	...
	@step_name NVARCHAR(50) = 'usp_load_landing_erp_cust_az12',
	@start_time DATETIME,
	@end_time DATETIME,
	@step_duration INT,
	...
	BEGIN TRY
		...
		SELECT @rows_loaded = COUNT(*) FROM landing.erp_cust_az12;
